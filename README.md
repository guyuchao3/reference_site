...
[Java](./docs/java.md)<!--rehype:style=background: rgb(211 55 49);-->
...
[Java](./docs/java.md)<!--rehype:style=background: rgb(211 55 49);&class=contributing-->  
[Julia](./docs/julia.md)<!--rehype:style=background: rgb(26 188 156);&class=contributing-->  
[Kotlin](./docs/kotlin.md)<!--rehype:style=background: rgb(211 55 49);&class=contributing-->  
[Kubernetes](./docs/kubernetes.md)<!--rehype:style=background: rgb(51 113 227);&class=contributing-->  
...
[Pytorch](./docs/pytorch.md)<!--rehype:style=background: rgb(238 76 44);&class=contributing tag&data-lang=Python-->  
<!--rehype:class=home-card-->
...
[ADB, Android Debug Bridge](./docs/adb.md)<!--rehype:style=background: rgb(238 0 0);&class=contributing tag&data-lang=Android-->  
[Ansible](./docs/ansible.md)<!--rehype:style=background: rgb(238 0 0);&class=contributing tag&data-lang=RedHat-->  
